...
```kotlin
implementation("io.github.gleb-skobinsky:themeanimator:0.0.15")
```
...
| Sliding                     | <video src="https://github.com/user-attachments/assets/63b67bbd-0253-4589-9133-f70851db1860" controls width="200"></video> |
| Circular reveal             | <video src="https://github.com/user-attachments/assets/e220a9ae-dcc5-43cd-b369-b38be2c535c4" controls width="200"></video> |
| Circular reveal around press| <video src="https://github.com/user-attachments/assets/8d737094-1e41-4769-9356-e3d74063e492" controls width="200"></video> |
...
implementation("io.github.gleb-skobinsky:themeanimator-storage:0.0.15")
